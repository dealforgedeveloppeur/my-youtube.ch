...
def LoadNewYoutubeur(UCID, name):
    result = subprocess.run(["/mnt/extra_disk/my-youtube.ch/yt-dlp", "--flat-playlist", "--print", "%(id)s", f"https://www.youtube.com/playlist?list={UCIDtoUUID(UCID)}"], capture_output=True, text=True)
